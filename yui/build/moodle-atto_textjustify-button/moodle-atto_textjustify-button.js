YUI.add('moodle-atto_textjustify-button', function (Y, NAME) {
...
/*
 * @package    atto_textjustify
 * @copyright  2015 Pau Ferrer Ocaña  <crazyserver@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

/**
 * @module moodle-atto_textjustify-button
 */

/**
 * Atto text editor textjustify plugin.
 *
 * @namespace M.atto_textjustify
 * @class button
 * @extends M.editor_atto.EditorPlugin
 */

Y.namespace('M.atto_textjustify').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
